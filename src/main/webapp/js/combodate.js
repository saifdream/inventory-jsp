...
(function ($) {
    ...
    Combodate.prototype = {
        ...
        init: function () {
            ...
            this.$widget = $('<span class="form-inline input-group combodate"></span>').html(this.getTemplate());
        ...
        */
        getTemplate: function() {
            ...
            $.each(this.map, function(k, v) {
                ...
                tpl = tpl.replace('{'+token+'}', '<select class="form-inline form-control input-sm '+k+' '+customClass +'"'+
