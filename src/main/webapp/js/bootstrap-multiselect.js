...
!function($) {"use strict";// jshint ;_;
    ...
    function Multiselect(select, options) {
        ...
        this.$container = $(this.options.buttonContainer).append('<button type="button" class="multiselect dropdown-toggle btn btn-btn-default btn-sm btn-block' + this.options.buttonClass + '" data-toggle="dropdown">' + this.options.buttonText(this.getSelected(), this.$select) + '</button>')
